...
//Buttons related to deleteShape
var deleteShapeButton = document.getElementById("deleteShapeButton");
var saveDeleteShapeButton = document.getElementById("saveDeleteShapeButton")
var cancelDeleteShapeButton = document.getElementById("cancelDeleteShapeButton");
...
function disableAllButtons() {
  const buttons = [addShapeButton, moveButton, deleteShapeButton, vertexEditButton];
  buttons.forEach(btn => {
    btn.disabled = true;
  });
}
...
function enableAllButtons() {
  ...
  if (extrusions.length > 0){
    deleteShapeButton.disabled = false;
    moveButton.disabled = false;
    vertexEditButton.disabled = false;
  }else{
    deleteShapeButton.disabled = true;
...
deleteShapeButton.addEventListener("click", function(){
  ...
  cancelDeleteShapeButton.classList.remove('hidden');
  saveDeleteShapeButton.classList.remove('hidden');
  disableAllButtons();
});

saveDeleteShapeButton.addEventListener("click", function(){
  isDeleting = false;
  camera.attachControl(canvas,true);
  cancelDeleteShapeButton.classList.add('hidden');
  saveDeleteShapeButton.classList.add('hidden');

  // Remove the extrusion
  if (extrusionToDelete){
  var extrusionIndex = extrusions.indexOf(extrusionToDelete);
  extrusions.splice(extrusionIndex, 1);
  extrusionToDelete.dispose();
  extrusionToDelete = null;
  }
  enableAllButtons();
});

cancelDeleteShapeButton.addEventListener("click", function(){
  isDeleting = false;
  if(extrusionToDelete){
      extrusionToDelete.visibility = 1;
      extrusionToDelete = null;
  }
  camera.attachControl(canvas, true);
  cancelDeleteShapeButton.classList.add('hidden');
...
doneEditButton.addEventListener("click", function(){
  ...
  removePointButton.classList.add('hidden');
...
addPointButton.addEventListener("click", function(){
  ...
  addPointButton.disabled = true;
  pointsTemp = [...points];
  addStartPointButton.classList.remove('hidden');
  addEndPointButton.classList.remove('hidden');
  doneAddPointButton.classList.remove('hidden');
});

addStartPointButton.addEventListener("click", function(){
  isAddingStart = true;
  doneAddPointButton.classList.add('hidden');
  saveAddingPointButton.classList.remove('hidden');
  cancelAddingPointButton.classList.remove('hidden');
  addEndPointButton.disabled = true;
  addStartPointButton.disabled = true;
});
...
saveAddingPointButton.addEventListener("click", function(){
  isAddingStart = false;
  isAddingEnd = false;
  doneAddPointButton.classList.remove('hidden');
  addEndPointButton.disabled = false;
  addStartPointButton.disabled = false;
  saveAddingPointButton.classList.add('hidden');
  cancelAddingPointButton.classList.add('hidden');
  points = [...pointsTemp];
});

cancelAddingPointButton.addEventListener("click", function(){
  isAddingStart = false;
  isAddingEnd = false;
  doneAddPointButton.classList.remove('hidden');
  addEndPointButton.disabled = false;
...
doneAddPointButton.addEventListener("click", function(){
  addStartPointButton.classList.add('hidden');
  addEndPointButton.classList.add('hidden');
  doneAddPointButton.classList.add('hidden');
  pointFigure.dispose();
  pointFigure = BABYLON.MeshBuilder.CreateLines("pointFigure", {points: points}, scene);
  doneEditButton.classList.remove('hidden');
  removePointButton.classList.remove('hidden');
  movePointButton.classList.remove('hidden');
...
removePointButton.addEventListener("click" , function(){
  ...
  cancelRemovePointButton.classList.remove('hidden');
  saveRemovePointButton.classList.remove('hidden');
  pointMeshes = [];
...
saveRemovePointButton.addEventListener("click", function(){
  cancelRemovePointButton.classList.add('hidden');
  saveRemovePointButton.classList.add('hidden');
...
cancelRemovePointButton.addEventListener("click", function(){
  cancelRemovePointButton.classList.add('hidden');
  saveRemovePointButton.classList.add('hidden');
  for (var i = 0; i < pointMeshes.length; i ++){
      pointMeshes[i].dispose();
